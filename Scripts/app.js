...
app.controller('CustomerTable', function ($scope, $http, AppApi) {
    $http({
        method: "GET",
        url: "http://theflowershop.gearhostpreview.com/api/Customers"
...
app.controller('ProductTable', function ($scope, $http, $cookieStore, $cookies, userPersistenceService, AppApi) {
    ...
    $http({
        method: "GET",
        url: "http://theflowershop.gearhostpreview.com/api/Suppliers"
    }).then(function mySuccess(response) {
...
app.controller('DriverTable', function ($scope, $http, AppApi, CurrentDriver) {
    $http({
        method: "GET",
        url: "http://theflowershop.gearhostpreview.com/api/Drivers"
    }).then(function mySuccess(response) {
...
app.controller('CheckoutController', function ($rootScope,$scope, $http, $cookieStore, $cookies, userPersistenceService) {
    ...
    }).then(function success(response)
    {
        ...
        $scope.saveOrder = function () {
            $http({
                method: "post",
                url: "http://theflowershop.gearhostpreview.com/api/CardInformations",
                dataType: "json",
                data: {
                    Address: $scope.address,
                    CustomerID: $scope.id,
                ...
                $http({
                    method: "post",
                    url: "http://theflowershop.gearhostpreview.com/api/Orders",
                    dataType: "json",
                    data: {
                        DriverID: $scope.driverID,
